...
using Simple = Fuse.Scripting.V8.Simple;

namespace Fuse.Babel
{
    static class V8SimpleExtensions
    {
        // Context
        ...
        public static JSContext Create(JSCallbackFinalizer callbackFinalizer, JSExternalFinalizer externalFinalizer)
        {
        ...
        static JSFunction CreateCallback(JSContext context, WrappedCallback callback, out JSScriptException error)
        {
        ...
        // Debug
        static JSDebugMessageHandler _cilMessageHandler = CilMessageHandlerImpl;
        static void CilMessageHandlerImpl(IntPtr data, JSString message)
        {
            var wrappedCallback = Handle.Target(data) as Action<JSString>;
            wrappedCallback(message);
        }
        public static void SetDebugMessageHandler(JSContext context, Action<JSString> messageHandler)
        {
    ...
    struct AutoReleasePool : IDisposable
    {
